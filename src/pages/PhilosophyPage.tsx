    ...
    <div className="pt-32 pb-24 bg-[#faf9f6] min-h-screen font-sans">
      <div className="container mx-auto px-6">
        ...
        <section className="max-w-4xl mb-32">
          ...
          >
            "En Un Té con Daniela, la cosmética es el puente. Proponemos un
            retorno a lo esencial, donde cada ingrediente es una invitación a
            sintonizar con los ritmos de la naturaleza y redescubrir nuestra
            propia vitalidad orgánica."
          </motion.p>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <h2 className="text-4xl font-black uppercase tracking-tighter text-brand-secondary mb-8 leading-tight">
                El Alma Detrás <br />{" "}
                <span className="text-brand-primary">de cada Gota.</span>
              </h2>
              <div className="space-y-6 text-lg text-brand-secondary/80 font-light leading-relaxed">
                <p>
                  En Un Té con Daniela, no solo formulamos; creamos puentes de
                  consciencia. Mi propuesta es transformar tu rutina en un
                  ritual de escucha botánica, donde los extractos puros y las
                  infusiones se conviertan en aliadas de tu regeneración celular
                  y equilibrio espiritual.
                </p>
                <p>
                  Nuestra propuesta se aleja de la cosmética industrial para
                  abrazar una alquimia honesta. Cada frasco es una invitación a
                  pausar, respirar la tierra y permitir que la sabiduría de las
                  plantas trabaje en armonía con tu propia piel, sin promesas
                  vacías, solo pureza real.
                </p>
        ...
        <section className="mb-32">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <h2 className="text-4xl font-black uppercase tracking-tighter text-brand-secondary mb-8 leading-tight">
                Historia y{" "}
                <span className="text-brand-primary">Proceso Consciente.</span>
              </h2>
              <div className="space-y-8">
                <div className="border-l-2 border-brand-primary/20 pl-8 transition-all hover:border-brand-primary">
                  <h3 className="text-xl font-black uppercase text-brand-secondary mb-2 tracking-tight">
                    El Origen
                  </h3>
                  <p className="text-brand-secondary/70 font-light leading-relaxed">
                    Un Té con Daniela nace en la quietud de un jardín,
                    observando cómo la naturaleza se regenera sin esfuerzo. Lo
                    que comenzó como una búsqueda personal de salud para la
                    piel, se transformó en un proyecto de vida dedicado a honrar
                    la botánica.
                  </p>
                </div>
                <div className="border-l-2 border-brand-primary/20 pl-8 transition-all hover:border-brand-primary">
                  ...
                  <p className="text-brand-secondary/70 font-light leading-relaxed">
                    Nuestro proceso no conoce de prisas. Seleccionamos plantas
                    de origen orgánico, respetando sus ciclos de cosecha. Cada
                    macerado y cada infusión reposa el tiempo necesario para
                    liberar su máxima potencia vibratoria y biológica.
                  </p>
                </div>
                <div className="border-l-2 border-brand-primary/20 pl-8 transition-all hover:border-brand-primary">
                  <h3 className="text-xl font-black uppercase text-brand-secondary mb-2 tracking-tight">
                    El Embajador Botánico
                  </h3>
                  <p className="text-brand-secondary/70 font-light leading-relaxed">
                    Cada producto es un mensajero de bienestar. Desde la
                    formulación técnica hasta el envasado artesanal, cuidamos
                    que la energía de la planta llegue intacta a tus manos,
                    creando una cadena de respeto que comienza en la tierra y
                    termina en tu ritual diario.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <section className="py-24 bg-[#e8efea] rounded-[5rem] p-12 md:p-24 relative overflow-hidden mb-32 border border-brand-primary/5">
          ...
          <div className="relative z-10">
            <div className="text-center mb-20 text-brand-secondary">
              ...
              <p className="text-brand-secondary/40 font-light uppercase tracking-widest text-[10px] transition-all">
        ...
        <section className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-black uppercase text-brand-secondary mb-8 tracking-tighter">
            Cultivando una <span className="text-brand-primary">Comunidad</span>{" "}
            <br /> que elige florecer.
          </h2>
          <p className="text-xl text-brand-secondary/60 font-light leading-relaxed mb-12">
            No estamos solas en este camino. Un Té con Daniela es una invitación
            a sentarte, respirar la fragancia de la lavanda y redescubrir tu
            propia belleza natural.
          </p>
...
function ValueCard({
  ...
  return (
    <div className="p-10 rounded-[3rem] bg-brand-wheat/50 border border-brand-primary/10 hover:bg-white hover:shadow-xl hover:shadow-brand-primary/5 transition-all group">
      ...
      <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-brand-secondary">
        {title}
      </h3>
      <p className="text-brand-secondary/60 font-light leading-relaxed text-sm">
        {desc}
      </p>
    </div>
  );
