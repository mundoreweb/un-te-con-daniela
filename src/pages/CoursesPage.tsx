...
import { Book, CheckCircle2, ChevronRight, ArrowLeft, Star, Clock, Award, Plus } from "lucide-react";
...
const courses: Course[] = [
  {
    ...
    features: ["Nociones básicas sobre la botánica", "Elaboración de oleatos", "Extractos botánicos en la cosmética", "Extracción gel de aloe vera"],
    popular: true,
  ...
  },
  {
    ...
    features: ["Datos interesantes de la historia del maquillaje", "Diferenciar el maquillaje natural del convencional", "Integrar el concepto de Slow Beauty", "Seleccionar las materias primas adecuadas"],
    popular: false,
  ...
  },
  {
    ...
    features: ["Identificar las características de tu cabello", "Comprender las necesidades de tu cabello", "Seleccionar las materias primas adecuadas", "Crear productos tales como champú sólido y líquido"],
    popular: false,
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mb-24">
          ...
          <p className="text-lg md:text-xl text-brand-secondary font-light max-w-2xl leading-relaxed">
            Nuestros programas están diseñados para empoderarte con el conocimiento técnico y la visión estratégica necesaria para dominar el arte de la formulación natural.
          </p>
        </div>
        ...
        <section className="py-24 mb-16 relative overflow-hidden">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-brand-secondary/70 max-w-2xl mx-auto font-light leading-relaxed">
              Fusionamos la ciencia cosmética con la sabiduría ancestral y el bienestar emocional. Una sinergia diseñada para quienes buscan ir más allá de la fórmula.
            </p>
          </div>
        ...
        <section className="pt-24 border-t border-brand-primary/10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-brand-secondary/60 font-light max-w-2xl mx-auto italic leading-relaxed">
              La transformación detrás de cada fórmula. Testimonios que inspiran el camino consciente.
            </p>
          </div>
  ...
  return (
    ...
    >
      <div className="mb-6 flex justify-center">
        <Star className="text-brand-primary fill-brand-primary opacity-40 group-hover:opacity-100 group-hover:scale-125 transition-all duration-500" size={32} />
      </div>
      ...
      <div className="mt-auto">
        <h4 className="text-lg font-black text-brand-secondary uppercase tracking-tight mb-1">{author}</h4>
        <p className="text-[10px] text-brand-primary uppercase font-black tracking-widest opacity-60">{location}</p>
      </div>
    </motion.div>
  );
}
    ...
    >
      ...
      <div className="lg:w-3/5 p-8 sm:p-12 md:p-20 flex flex-col justify-center">
        ...
        <div className="grid sm:grid-cols-2 gap-8 mb-12">
          <div className="space-y-4">
            {course.features.map((feature, idx) => (
              <div key={idx} className="flex items-center gap-3">
                ...
                <span className="text-xs font-bold font-sans uppercase tracking-[0.1em] text-brand-forest/60">{feature}</span>
              </div>
            ))}
          </div>
          <div className="space-y-6">
             <div className="flex items-center gap-3">
                ...
                <div>
                   <p className="text-[10px] uppercase font-black opacity-40">Duración</p>
             ...
             <div className="flex items-center gap-3">
                ...
                <div>
                   <p className="text-[10px] uppercase font-black opacity-40">Certificación</p>
        ...
        <div className="flex items-center justify-between pt-8 border-t border-brand-primary/10">
           <div>
              <p className="text-[10px] uppercase font-black opacity-40 mb-1">Inversión Final</p>
              <p className="text-4xl font-black text-brand-primary">{course.price}</p>
           </div>
           <motion.a
...
function FacilitatorCard({ name, role, desc, image, index }: { name: string; role: string; desc: string; image: string; index: number }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <div className="absolute inset-0 z-20 p-10 flex flex-col justify-end transform transition-transform duration-500">
        <div className="overflow-hidden">
          <motion.p 
            className="text-[10px] uppercase font-black tracking-[0.4em] text-brand-wheat mb-2 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500"
          >
