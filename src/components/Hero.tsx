    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          >
            Lo esencial para tu <span className="text-[#d8b4fe]">belleza</span>{" "}
            y cuidado personal.
          </motion.h1>
          ...
          >
            Enseñamos a mujeres comprometidas a elaborar y usar cosmética
            natural de forma sostenible, a través de talleres online, productos
            y asesorías.
          </motion.p>
